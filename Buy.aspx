<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Buy.aspx.cs" Inherits="Smart_and_safe.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <asp:TextBox class="search text-center" ID="TextBox1" runat="server" placeholder="What are you looking for?"></asp:TextBox>
       <asp:Button ID="Button2" class="button" runat="server" Text="Go" UseSubmitBehavior="False" CausesValidation="False" OnClick="Button2_Click" />
